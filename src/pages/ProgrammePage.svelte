  ...
  <div class="wrapper">
    ...
    <div class="social">
      ...
      <div class="discord1">
        ...
        {#if programme.title === "Datamatiker" || programme.title === "Multimediedesign" || programme.title === "IT-Sikkerhed" || programme.title === "Business Økonomi-IT"}
        ...
        {:else}
          ...
          {/if}
          {#if programme.title === "IT-Softwareudvikling"} 
